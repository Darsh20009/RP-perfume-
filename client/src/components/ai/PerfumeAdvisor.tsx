...
export function PerfumeAdvisor() {
  ...
  const handleSend = async () => {
    ...
    try {
      const res = await fetch("/api/ai/perfume-advisor", {
        method: "POST",
          ...
          >
            ...
            >
              ...
              <button
                ...
                className="absolute -top-2 -left-2 w-6 h-6 rounded-full bg-gray-200 flex items-center justify-center hover:bg-gray-300 transition-colors"
              >
