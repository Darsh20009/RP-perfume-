...
const translationsFull = {
  ar: {
    ...
    madeWithLove: "رفيف العود | RF Perfume",
    signIn: "تسجيل الدخول",
    ...
    brandStoryDesc: "في رفيف العود، نؤمن أن العطر ليس مجرد رائحة، بل هو تعبير عن الشخصية. نحرص على اختيار أرقى العطور الشرقية والغربية لنقدم لك تجربة فريدة.",
