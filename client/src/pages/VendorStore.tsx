  ...
  return (
    <Layout>
      ...
      <div className="max-w-6xl mx-auto px-6 pt-10 mb-8">
        <h1 className="text-3xl md:text-4xl font-black">{vendor.storeName}</h1>
        {vendor.storeNameEn && <p className="text-muted-foreground text-sm mt-1">{vendor.storeNameEn}</p>}
      </div>
